...
#
# Reuses as-is constructions from three earlier exploratory scripts
# (milestones/regions/electoral system/stability/size/cohorts/power;
# competitiveness; income), not included in this package.
...
FIG      <- file.path(PROJECT, "code/twfe/figures")
