...
#   the shared reference cohort used throughout simple_regression/publication).
...
ctrl_codes <- read_csv(file.path(PROJECT, "simple_regression/robsocioeco/data/control_group_new.csv"),
