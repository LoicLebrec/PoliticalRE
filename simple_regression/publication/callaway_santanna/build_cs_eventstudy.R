...
PUB     <- file.path(PROJECT, "simple_regression/publication/callaway_santanna")
...
turnover <- read_csv(file.path(PROJECT, "simple_regression/CRcreu11/data/turnover_candidats.csv"),
...
ctrl_matched  <- read_csv(file.path(PROJECT, "simple_regression/robsocioeco/data/control_group_new.csv"),
                           col_types=col_spec) %>% pull(code_insee) %>% unique()
ctrl_baseline <- read_csv(file.path(PROJECT, "simple_regression/CRcreu11/data/control_group.csv"),
                           col_types=col_spec) %>% pull(code_insee) %>% unique()
