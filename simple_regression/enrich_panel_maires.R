...
#
# Source: data/maires_panel.csv (built by scripts/build_maires_panel.py)
...
# Output: simple_regression/panel/panel_maires.csv
...
OUT     <- file.path(PROJECT, "simple_regression/panel/panel_maires.csv")
