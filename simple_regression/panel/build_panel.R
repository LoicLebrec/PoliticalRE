...
OUT     <- file.path(PROJECT, "simple_regression/panel/panel.csv")
...
# computes them -- confirmed, see simple_regression/publication/replication/
...
external <- read_csv(
  file.path(PROJECT, "simple_regression/panel/external_wind_voteshare.csv"),
  col_types = cols(code_insee = col_character(), .default = col_guess())
)
